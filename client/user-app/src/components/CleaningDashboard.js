...
function CleaningDashboard() {
  const services = [
    { name: 'House Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Deep Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Kitchen Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Bathroom Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Sofa Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Carpet Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Window Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' },
    { name: 'Office Cleaning', image: cleaningImg, price: 220, rating: 4.9, reviews: '2.2 M' }
  ];
  ...
  return (
    <div className="most-booked-container">
      <h2 className="most-booked-title">Cleaning</h2>
